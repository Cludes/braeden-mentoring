---
layout: page
title: "Year One: Review and Year Two Planning"
week_number: "52"
...
> Week 52. You made it through the first year.
> 
> This is not the end. It is the point where you know enough to choose your own direction.
> 
> Look back at what you have covered:
> - Web development: HTML, CSS, JavaScript, DOM, Fetch API, Node.js
> - Python: fundamentals, data structures, automation, scraping, APIs
> - Linux command line and Git
> - How the internet works at a protocol level
> - Cybersecurity: CIA triad, OWASP, network attacks, XSS, SQLi, hash cracking, OSINT, Burp Suite, privilege escalation, Metasploit
> - CTF competitions on PicoCTF and HackTheBox (through Tier 2)
> - Bug bounty basics and report writing
> - DevOps: Docker, GitHub Actions, SAST, secret scanning, cloud security
> - Career paths, certifications, and community
> 
> This session is a reflection and planning conversation with Andrew.
...
## Activity: Year Review and Year Two Plan

1. Write a reflection document (at least one page): what was the most interesting thing you learned, what was hardest, what clicked that you did not expect, what you want to go deeper on
1. Review your GitHub profile: how many public repos do you have, how many commits in the last year, what tools did you build
1. Set three concrete goals for Year Two with a timeline: e.g. 'Pass eJPT by August 2027', 'Solve 50 HackTheBox machines by December 2027', 'Make 5 open source contributions by July 2027'
1. Discuss the goals with Andrew. Adjust based on what is realistic given your schedule
1. Andrew will update the curriculum with Year Two content after this session
1. You know you are done when your reflection is written and you have three written, agreed goals for Year Two
...
1. What is the one skill from this year that you feel most confident in?
2. What is the one area you feel least confident in that you want to improve?
3. What does success look like for you in cybersecurity in 2 years? Be specific.
4. What would you tell someone starting from zero about the most important thing to focus on first?
