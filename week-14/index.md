...
> Week 14. Passwords and hashing.
> 
> Hash cracking is one of the first skills in both offensive security (cracking leaked password databases) and defensive security (verifying password policies are enforced).
> 
> This week you will build a hash cracker in Python and understand why MD5 and SHA1 are not safe for passwords. You will also learn what makes bcrypt and Argon2 different.
> 
> Note: only crack hashes you own or that are provided in a controlled lab. This week's activity uses hashes you generate yourself.
...
## Activity: Hash Cracker Activity

1. Open the activity at activities/cybersecurity/easy/04_hash-cracker.md and follow the instructions
1. First generate MD5 hashes for these passwords: 'password', 'Password1', '123456', 'letmein'
1. Use Python's hashlib to implement a dictionary attack against those hashes using a wordlist
1. Use the rockyou.txt wordlist (download from: https://github.com/danielmiessler/SecLists or use a smaller sample)
1. Add a brute-force mode that tries all combinations of lowercase letters up to length 4
1. Test your brute-force on the hash of 'dog' -- it should crack it
1. You know you are done when your dictionary attack cracks at least 3 of the 4 test hashes and the brute-force cracks 'dog'
...
2. Why is MD5 not suitable for storing passwords even if the hash cannot be reversed mathematically?
3. What is a rainbow table attack and what defence defeats it?
4. What makes bcrypt better than SHA256 for password storage?
