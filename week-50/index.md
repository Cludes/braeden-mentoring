...
> 
> Certifications signal baseline knowledge to employers. They are not a replacement for hands-on skills, but they open doors that skills alone sometimes do not.
> 
> This is a research and planning week. No labs -- but this information will directly affect what you do after Week 52.
...
## Activity: Certification Research and Study Plan

1. Research each of these certifications in depth: CompTIA Security+ (entry level, widely recognised in Australia), CompTIA PenTest+ (intermediate, offensive focus), eJPT (eLearnSecurity Junior Penetration Tester -- practical, beginner friendly), CEH (Certified Ethical Hacker -- more theoretical), OSCP (Offensive Security Certified Professional -- the most respected hands-on cert, very hard)
1. For each: exam cost, format (multiple choice vs practical), study time estimate, relevance to your chosen career path
1. Recommended starting point if you want offensive security: eJPT (affordable, practical, builds on what you know)
1. Explore the free eLearnSecurity INE Starter Pass which includes material for eJPT: https://ine.com
1. Write a study plan: which cert you will pursue first, how many hours per week you can dedicate, and a target exam date
1. Discuss with Andrew
...
1. What is the difference between eJPT and OSCP?
2. Why do many security professionals say OSCP is the most valuable cert?
3. CompTIA Security+ is multiple choice only. What are the limitations of that format for proving practical skills?
4. How much does the OSCP exam cost and what does it involve?
